...
class SettingTab(QtGui.QWidget):
    ...
    def retranslateUi(self ):
        ...
        self.comboBox_3.setItemText(0, _translate("Form", "Cartesian", None))
        self.comboBox_3.setItemText(1, _translate("Form", "Cylindrical", None))
        self.comboBox_3.setItemText(2, _translate("Form", "Spherical", None))
        ...
        self.comboBox_2.setItemText(4, _translate("Form", "From Plots", None))
